          ...
          <div className="space-y-6 animate-fade-in-right">
            ...
            <div className="flex flex-wrap items-center gap-2.5 pt-2">
              ...
              <button
                ...
                data-cursor-hover
                className="inline-flex items-center gap-2 bg-gradient-to-r from-primary-purple via-primary-purple via-35% to-primary-blue text-white text-sm font-semibold px-4 py-2 rounded-full shadow-lg shadow-primary-purple/30 hover:shadow-xl hover:shadow-primary-purple/50 hover:scale-105 transition-all duration-300"
              >
